...
PLATFORM_NAME = "qpu169_f0"        # Used for the data directory and device config file name.
LOAD_CFG_FILE = False           # Set True to load hardware config from the saved JSON file.
from init_scripts.hw_configs.cfg_qpu169_f0 import HW_CONFIG_DICT
...
def initialize(
    ...
    # -- Qubit elements --
    helper_configure_ladder(quantum_device, num_qubits=8, feedlines={"f0": ["q0", "q1", "q2","q3"]})
