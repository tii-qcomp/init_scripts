...
HW_CONFIG_DICT = {
    ...
    **QbloxHardwareCompilationConfig(
        hardware_description = {
            "cluster": QbloxHardwareDescription(
        ...
        connectivity=Connectivity.model_validate(
            {"graph": [
                ("cluster.module9.complex_output_0", "q0:mw"),
                ("cluster.module9.complex_output_1", "q1:mw"),
                ("cluster.module8.complex_output_0", "q2:mw"),
                ("cluster.module8.complex_output_1", "q3:mw"),
                ("cluster.module7.complex_output_0", "q4:mw"),
                ("cluster.module7.complex_output_1", "q5:mw"),
                ("cluster.module6.complex_output_0", "q6:mw"),
                ("cluster.module6.complex_output_1", "q7:mw"),
                ("cluster.module20.complex_output_0", "q0:res"),
                ("cluster.module20.complex_output_0", "q1:res"),
                ("cluster.module20.complex_output_0", "q2:res"),
                ("cluster.module20.complex_output_0", "q3:res"),
                ("cluster.module18.complex_output_0", "q4:res"),
                ("cluster.module18.complex_output_0", "q5:res"),
                ("cluster.module18.complex_output_0", "q6:res"),
                ("cluster.module18.complex_output_0", "q7:res"),
                ("cluster.module18.complex_output_0", "f1:in"),
                ("cluster.module20.complex_output_0", "f0:in"),
            ]}
        ).model_dump(),
    ).model_dump(),
}
