    ...
    **QbloxHardwareCompilationConfig(
        ...
        connectivity=Connectivity.model_validate(
            {"graph": [
                ...
                ("cluster0.module12.complex_output_1", "q5:mw"),
                ("cluster0.module10.complex_output_0", "q6:mw"),
                ("cluster0.module10.complex_output_1", "q7:mw"),
                ("cluster0.module18.complex_output_0", "q4:res"),
                ("cluster0.module18.complex_output_0", "q5:res"),
                ("cluster0.module18.complex_output_0", "q6:res"),
                ("cluster0.module18.complex_output_0", "q7:res"),
                ("cluster0.module18.complex_output_0", "f1:in"),
            ]}
        ).model_dump(),
    ).model_dump(),
}
