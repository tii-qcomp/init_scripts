...
PLATFORM_NAME = "qpu187"        # Used for the data directory and device config file name.
LOAD_CFG_FILE = True           # Set True to load hardware config from the saved JSON file.
from init_scripts.hw_configs.cfg_qpu187 import HW_CONFIG_DICT
...
# Create the QuantumDevice class with the initialize function, to get a fully configured QuantumDevice instance.
